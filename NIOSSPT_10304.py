...
class Network(unittest.TestCase):
    ...
    def test_105_validate_infoblox_logs(self):
        ...
        keyword2=len(re.findall(r'Cache bypass flag set to OFF', result))
        if ((keyword1 > 1) and (keyword2 > 1)): #Validating greater than 1 because, at the beginning we would have started the DCA already once
    ...
    def test_110_validate_infoblox_logs(self):
        display_msg("Validating infoblox logs...")
